...
<body>
   <div class="wrapper">
      ...
      <div class="body">
         <div class="container">
            <form class="form-container" enctype="multipart/form-data" action="inc/singup.php" method="post">
               <label for="full_name">Ф.И.О</label>
               <input id="full_name" name="full_name" maxlength="100" type="text" required>
               <label for="name">Логин</label>
               <input id="name" name="name" maxlength="50" type="text" required>
               <label for="email">Email</label>
               <input id="email" name="email" type="text" required>
               <label for="avatar">Изображение профиля</label>
               <label id="file-btn" for="avatar">Загрузить</label>
               ...
               <input id="password-two" name="password-two" type="password" inputmode="numeric" required>
               <input type="submit" value="Зарегестрироваться">
               <?php
               if ($_SESSION['Err_pass-comf']) {
                  echo '<p class="msg"> ' . $_SESSION['Err_pass-comf'] . '</p>';
                  unset($_SESSION['Err_pass-comf']);
               }
               ?>
            </form>
         </div>
